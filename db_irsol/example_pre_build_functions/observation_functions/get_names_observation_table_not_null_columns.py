...
# This method returns all the not null columns names of the table Observation.
# The not null columns are all the fields (columns) that when a record is insert can't be null.
not_null_columns = ObservationFunctions.get_names_observation_table_not_null_columns(gateways_manager)
