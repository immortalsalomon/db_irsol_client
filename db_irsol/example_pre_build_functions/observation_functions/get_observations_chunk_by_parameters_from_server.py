...
# This method returns the observations in the database that match the parameters passed within the range
...
observations = ObservationFunctions.get_observations_chunk_by_parameters_from_server("<start_element_number>",
                                                                                     "<number_of_elements>",
