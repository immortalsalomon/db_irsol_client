...
# Delete a observation in the database. The method returns true if the observation is delete otherwise return false.
...
result = ObservationFunctions.delete_observation_on_server_from_dir("path", gateways_manager)
