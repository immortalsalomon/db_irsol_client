...
# Delete a measurement in the database. The measurement need to be present in the database.
...
result = MeasurementFunctions.delete_measurement_on_server_from_file("path", gateways_manager)
