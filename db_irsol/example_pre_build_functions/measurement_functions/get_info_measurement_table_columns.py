...
# This method returns all the columns and their information of the table Measurement.
columns_info = MeasurementFunctions.get_info_measurement_table_columns(gateways_manager)
