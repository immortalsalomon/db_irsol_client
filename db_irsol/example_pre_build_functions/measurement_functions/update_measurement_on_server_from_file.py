...
# Update a measurement in the database. The measurement need to be present in the database.
# You need to pass a valid path to the following method. Replace the placeholder path with the path of the measurement
# file, like = "/home/mushu/Desktop/git_irsol/2018/181023/raw/s5140m1_d5.z3bd".
# This method returns the id of the new added measurement to update the old measurement.
result = MeasurementFunctions.update_measurement_on_server_from_file("path", gateways_manager)
