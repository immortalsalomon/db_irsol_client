...
# Add the observation to the database. The function return the id of the observation record on the database.
id_record_observation = ObservationFunctions.insert_observation_on_server(observation, gateways_manager)

# This method adds the measurements from one or more directories into the database.
...
ids_records_measurements = MeasurementFunctions.insert_measurements_on_server_from_dirs(["path", "path"],
                                                                                        id_record_observation,
                                                                                        gateways_manager)
