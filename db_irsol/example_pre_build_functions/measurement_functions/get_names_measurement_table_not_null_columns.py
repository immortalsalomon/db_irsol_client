...
# This method returns all the not null columns names of the table Measurement.
# The not null columns are all the fields (columns) that when a record is insert can't be null.
not_null_columns = MeasurementFunctions.get_names_measurement_table_not_null_columns(gateways_manager)
