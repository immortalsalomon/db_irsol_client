...
# This method returns the measurements in the database that match the parameters passed.
...
measurements = MeasurementFunctions.get_measurements_by_parameters_from_server(parameters, gateways_manager)
